...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-b6nhpwq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-b6nhpwq.containers.anotherwebservice.com/
...
```
git clone git@github.com:devarxify/container-b6nhpwq.git
cd container-b6nhpwq
```
...
```
docker attach container-b6nhpwq
```
